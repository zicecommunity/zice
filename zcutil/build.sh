...
$0 [ --enable-lcov || --disable-tests ] [ --disable-mining ] [ --enable-proton ] [ MAKEARGS... ]
  ...
  If --enable-lcov is passed, ZiCE is configured to add coverage
  instrumentation, thus enabling "make cov" to work.
  If --disable-tests is passed instead, the ZiCE tests are not built.

  If --disable-mining is passed, ZiCE is configured to not build any mining
