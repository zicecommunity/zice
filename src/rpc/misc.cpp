...
{
public:
    UniValue operator()(const libzice::InvalidEncoding &zaddr) const { return UniValue(UniValue::VOBJ); }

    UniValue operator()(const libzice::SproutPaymentAddress &zaddr) const {
        UniValue obj(UniValue::VOBJ);
    ...
    UniValue operator()(const libzice::SaplingPaymentAddress &zaddr) const {
        UniValue obj(UniValue::VOBJ);
