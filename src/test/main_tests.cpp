...
BOOST_AUTO_TEST_CASE(subsidy_limit_test)
{
    ...
    BOOST_CHECK_EQUAL(nSum, 500000000);
    ...
    BOOST_CHECK_EQUAL(nSum, 420000000000000);
    // Regular mining
    ...
    // 11th), decreasing the total monetary supply by 0.0693 ZCE. If the
    // transaction output field is widened, this discrepancy will become smaller
    // or disappear entirely.
    //BOOST_CHECK_EQUAL(nSum, 2099999997690000ULL);
    BOOST_CHECK_EQUAL(nSum, 839999989080000);
}
