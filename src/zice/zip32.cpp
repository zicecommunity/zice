...
boost::optional<std::pair<diversifier_index_t, libzice::SaplingPaymentAddress>>
    SaplingExtendedFullViewingKey::Address(diversifier_index_t j) const
{
    ...
    CSerializeData addr_bytes(libzice::SerializedSaplingPaymentAddressSize);
...
libzice::SaplingPaymentAddress SaplingExtendedFullViewingKey::DefaultAddress() const
{
...
libzice::SaplingPaymentAddress SaplingExtendedSpendingKey::DefaultAddress() const
{
...
bool IsValidSpendingKey(const libzice::SpendingKey& zkey) {
    return zkey.which() != 0;
}
