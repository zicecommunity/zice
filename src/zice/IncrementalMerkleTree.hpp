...
} // end namespace `libzice`

typedef libzice::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH, libzice::SHA256Compress> SproutMerkleTree;
typedef libzice::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libzice::SHA256Compress> SproutTestingMerkleTree;

typedef libzice::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH, libzice::SHA256Compress> SproutWitness;
typedef libzice::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libzice::SHA256Compress> SproutTestingWitness;

typedef libzice::IncrementalMerkleTree<SAPLING_INCREMENTAL_MERKLE_TREE_DEPTH, libzice::PedersenHash> SaplingMerkleTree;
typedef libzice::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libzice::PedersenHash> SaplingTestingMerkleTree;

typedef libzice::IncrementalWitness<SAPLING_INCREMENTAL_MERKLE_TREE_DEPTH, libzice::PedersenHash> SaplingWitness;
typedef libzice::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libzice::PedersenHash> SaplingTestingWitness;
