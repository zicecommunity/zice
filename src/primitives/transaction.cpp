...
{
    std::array<libzice::SproutNote, ZC_NUM_JS_OUTPUTS> notes;
...
public:
    ...
    bool operator()(const libzice::PHGRProof& proof) const
    {
    ...
    bool operator()(const libzice::GrothProof& proof) const
    {
