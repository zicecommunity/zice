...
[the ZiCE protocol spec](https://github.com/zice/zips/blob/master/protocol/protocol.pdf),
...
- **Caution:** for z-addresses, these balances will **not** be accurate if any
  ...
  (e.g. [#2542](https://github.com/zice/zice/issues/2542)).
...
Jack Grigg (40):
      ...
      build: Split hardening/fPIE options out in ZiCE-specific binaries
      Change --enable-werror to apply to all warnings, use it in build.sh
      Move ZiCE flags into configure.ac
      ViewingKey -> ReceivingKey per zice/zips#117
      ...
      Add watch-only support to ZiCE RPC methods
...
syd (13):
      ...
      Rename bash completion files so that they refer to zice and not bitcoin.
