...
Jack Grigg (14):
      ...
      Convert ZiCE versions to Debian format
      ...
      Implement automatic shutdown of deprecated ZiCE versions
...
Jay Graber (2):
      Change help text examples to use ZiCE addresses
...
Nathan Wilcox (39):
      ...
      Add all of the zice release tags in my current repo as positive test vector.
      ...
      Reuse zice_rpc.
      Do not use `-rpcwait` on all `zice_rpc` invocations, only block when starting ziced.
