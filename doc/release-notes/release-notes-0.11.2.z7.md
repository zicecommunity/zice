...
Taylor Hornby (17):
      ...
      Rename zerocash to zice in some places.
      Remove references to libzerocash in .gitignore
      Rename qa/zerocash to qa/zice in Makefile.am
      Rename zerocash_packages to zice_packages in packages.mk
