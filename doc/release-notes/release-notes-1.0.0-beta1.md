...
Lars-Magnus Skog (1):
      changed module name from "bitcoin" to "ZiCE" in FormatException()
...
Simon (91):
      ...
      Reduce use of global pziceParams with private member variable
      Revert "Reduce use of global pziceParams with private member variable"
      Replace ziceParams_ with global.
