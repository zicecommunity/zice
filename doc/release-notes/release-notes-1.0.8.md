...
Daira Hopwood (15):
      ...
      Update which libraries are allowed to be linked to ziced by symbol-check.py.
      ...
      Line-wrap privacy notice. Use <> around URL and end sentence with '.'. Include privacy notice in help text for ziced -help.
...
Jay Graber (5):
      ...
      Add security warning to zice-cli --help and --version message output
      Add security warning to ziced metrics display
