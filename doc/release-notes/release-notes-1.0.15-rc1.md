...
Additional information relating to running on low-memory systems can be found here: [reducing-memory-usage.md](https://github.com/zice/zice/blob/master/doc/reducing-memory-usage.md).
